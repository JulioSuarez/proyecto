    ...
    <div class="flex justify-center my-8 space-x-8">
        ...
        {{-- @foreach ($membresias as $membresia) --}}
            <div
                ...
                {{-- {{ $membresia->nombre }} --}}
                <input type="hidden" value="" name="i_membresia">
                ...
                {{-- @if (in_array($membresia->id, $detalle_membre))
                    <form action="{{ route('membresia.cancelar', $membresia->id) }}" method="post">
                            @csrf @method('DELETE')
                ...
                @else --}}
                {{-- {{ route('membresia.pago', $membresia->id) }} --}}
                    <a href="{{ route('suscripciones.realizar_pago', 1)}}" type="submit"
        ...
        @if (session()->has('success'))
            <script>
                Swal.fire({
                    position: "top-end",
                    icon: "success",
                    title: "Membresia adquirida con exito",
