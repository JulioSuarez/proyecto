<x-guest-layout>
 ...
 <form class="w-full  flex justify-center" method="POST" action="{{ route('register') }}">
    @csrf
    ...
    <div class=" w-1/4 mt-6 px-6 py-4 bg-white shadow-md sm:rounded-lg">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password_confirmation" class="block mt-1 w-full" wire:model="password_confirmation"
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            {{-- <button type="button" wire:click='storeUser' class="btn-black">
                {{ __('Register') }}
            </button> --}}
