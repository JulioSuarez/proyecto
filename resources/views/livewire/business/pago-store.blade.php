<div>
    <div class="flex ">
        <ul class=" w-1/2 space-y-4  pr-8  border-r border-gray-500">
            <h3 class="mb-5 text-lg font-medium text-gray-900 dark:text-white"> {{ __('Credit store:') }}</h3>
            ...
            <li>
                ...
                <label for="credit_20"
                    ...
                    <div class="flex space-x-8">
                        <img class="h-12 w-12" src="{{ asset('/images/star.png') }}" alt="">
                        <div>
                            <div class="w-full text-lg font-semibold"> $ 5.00 </div>
                            <div class="w-full text-sm"> 20 credits</div>
                        </div>
                    </div>
                </label>
            </li>
            ...
            <li>
                ...
                <label for="credit_50"
                    ...
                    <div class="flex space-x-8">
                        <img class="h-12 w-12" src="{{ asset('/images/star.png') }}" alt="">
                        <div>
                            <div class="w-full text-lg font-semibold"> $ 10.00 </div>
                            <div class="w-full text-sm"> 50 credits</div>
                        </div>
                    </div>
                </label>
            </li>
            ...
            <li>
                ...
                <label for="credit_80"
                    ...
                    <div class="flex space-x-8">
                        <img class="h-12 w-12" src="{{ asset('/images/star.png') }}" alt="">
                        <div>
                            <div class="w-full text-lg font-semibold"> $ 15.00 </div>
                            <div class="w-full text-sm"> 80 credits</div>
                        </div>
                    </div>
                </label>
            </li>
        ...
        <div class="w-1/2 pl-8">
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div class="p-4 md:p-5 space-y-4">
                                        <div class=" w-full ">
                                            ...
                                            <div class="mb-3">
                                                <label class="text-gray-600 font-semibold text-sm mb-2 ml-1">Numero de
                                                    tarjeta</label>
                                                <div id="card-element"
            ...
            <div class="flex-1 ">
                ...
                <button class="btn-blue py-2 flex w-full justify-center disabled:opacity-25" wire:click="realizarPago"
                    wire:target="realizarPago" wire:loading.attr="disabled">
